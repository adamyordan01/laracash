<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-md-none">
    <a class="navbar-brand mr-lg-5" href="{{ asset('volt/index.html') }}">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item {{ request()->is('lecturer*') ? 'active' : '' }}">
                <a href="/lecturer" class="nav-link">
                    <span class="sidebar-icon"><span class="fas fa-user-graduate"></span></span>
                    <span>Dosen</span>
                </a>
            </li>
            <li class="nav-item ">
            ...
            <a href="https://themesberg.com" target="_blank" class="nav-link d-flex align-items-center">
                <span class="sidebar-icon">
                <img src="{{ asset('volt/assets/img/themesberg.svg') }}" height="20" width="20" alt="Themesberg Logo">
                </span>
