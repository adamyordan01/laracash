    ...
    <div class="container position-relative">
        ...
        <div class="navbar-collapse collapse w-100 justify-content-between" id="navbar-default-primary">
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                <li class="nav-item {{ request()->is('me*') ? 'active-link' : '' }} ">
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    <a class="nav-link pt-1 px-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <div class="media d-flex align-items-center">
                        @if (Auth::user()->picture)
                            <img class="user-avatar md-avatar rounded-circle" alt="Image placeholder" src="{{ asset(Auth::user()->takePicture) }}">
                        @else
                            <img class="user-avatar md-avatar rounded-circle" alt="Image placeholder" src="{{ asset('volt/assets/img/team/profile.png') }}">
                        @endif
                    ...
                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-right mt-2">
                      <a class="dropdown-item font-weight-bold" href="/profile/show/{{ Auth::user()->id }}"><span class="far fa-user-circle"></span>My Profile</a>
                      <a class="dropdown-item font-weight-bold" href="/password/edit"><span class="fas fa-cog"></span>Change Password</a>
