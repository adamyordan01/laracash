<!-- Core -->
<script src="{{ asset('volt/vendor/popper.js/dist/umd/popper.min.js') }}"></script>
...
<!-- Jarallax -->
<script src="{{ asset('volt/vendor/jarallax/dist/jarallax.min.js') }}"></script>

<!-- Smooth scroll -->
<script src="{{ asset('volt/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js') }}"></script>

<!-- Count up -->
<script src="{{ asset('volt/vendor/countup.js/dist/countUp.umd.js') }}"></script>
